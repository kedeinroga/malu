...
<meta charset="utf-8">
<meta name="keywords" content="Malu, cafe, restaurant, 
comida, huancayo, Samsung, LG, SonyEricsson, Motorola web design" />
				...
				<div class="w3-header-top-grids">
					...
					<div class="w3-header-top-right">
						...
						<div class="w3-header-top-right-text">
							<p><i class="fa fa-home" aria-hidden="true"></i> 1st Street , Huancayo</p>
						</div>
			...
			<div class="head">
				<div class="head-nav-grids">
					<div class="navbar-top">
							  ...
							  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
								...
								<span class="icon-bar"></span>
								 ...
								 <div class="navbar-brand logo ">
									<h1><a href="index.html">Malu <span>Restaurant & Coffee</span></a></h1>
								</div>
							...
							<li class="active"><a href="index.html" data-hover="Home">Inicio</a> </li>
								<li><a href="nosotros.html" data-hover="About">Nosotros </a> </li>
							...
							<ul class="rslides callbacks callbacks1" id="slider4">
								<li>
									<div class="agileits-banner-info">
										<h3>La Mejor Comida <span>Tradicional de Huancayo</span></h3>
										<div class="w3-button">
								...
								<li>
									<div class="agileits-banner-info">
										<h3>El Mejor Café <span>Malu la mejor opción</span></h3>
										<div class="w3-button">
											<a href="single.html">Más</a>
										</div>
									</div>
	...
	<div class="w3-agile-footer">
		<div class="container">
			<div class="footer-grids">
				<div class="col-md-3 footer-grid">
					<div class="footer-grid-heading">
						<h3><a href="index.html">Malu <span>Restaurant & Coffee</span></a></h3>
					</div>
			...
			<div class="agileits-w3layouts-copyright">
				<p>© 2017 Malu . All Rights Reserved | Design by Malu</a> </p>
			</div>
		</div>
	</div>
	<!-- //footer -->
